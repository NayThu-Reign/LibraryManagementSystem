                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        @else
                            <ul class="navbar-nav" style="font-size: 16px">
                                <li class="nav-item">
                                    <a href="{{url('/books')}}" class="nav-link text-light">Books</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('/authors')}}" class="nav-link text-light">Authors</a>
                                </li>
                                <li class="nav-item">
                                ...
                                @auth
                                    @if (auth()->user()->roles_id == 2)
                                        <li class="nav-item">
                                            <a href="{{ url("/issuebooks")}}" class="nav-link text-light">Issued Books</a>
                                        </li>
                                    @endif
                                @endauth
